<x-app-layout>
    ...
    <x-card title="Berikut hasil diagnosa penyakit">
        <p class="mb-4">
            ...
            <i class="fas fa-calendar ml-4 mr-1"></i> {{ $riwayat->created_at->format('d M Y, H:m:s') }}
        </p>
        ...
        @foreach (unserialize($riwayat->hasil_diagnosa) as $diagnosa)
            <div class="card card-body p-0 mt-5 border" style="box-shadow: none !important;">
                <div class="card-header bg-primary text-white p-2">
                    <h6 class="font-weight-bold">Tabel perhitungan penyakit: {{ $diagnosa['nama_penyakit'] }}
                        ({{ $diagnosa['kode_penyakit'] }})</h6>
                </div>
        ...
        <div class="mt-5">
            <div class="alert alert-success">
                ...
                <p>Berdasarkan dari gejala yang kamu pilih atau alami juga berdasarkan Role/Basis aturan yang sudah
                    ditentukan oleh seorang pakar penyakit maka perhitungan Algoritma Certainty Factor mengambil nilai
                    CF yang paling pinggi yakni <b>{{ number_format(unserialize($riwayat->cf_max)[0], 3) }}
            ...
            <div class="mt-3 text-center">
                ...
                <a href="{{ route('admin.diagnosa') }}" class="btn btn-warning mr-1"><i class="fas fa-redo mr-1"></i>
                    Diagnosa ulang</a>
                <a href="{{ route('admin.showCalculateDs', $riwayat->id) }}" class="btn btn-success mr-1"><i
