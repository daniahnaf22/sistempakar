                ...
                <tbody>
                    @forelse($riwayat as $row)
                        <tr>
                            ...
                            <td>
                                {{-- <a href="{{ asset("storage/downloads/$row->file_pdf") }}" target="_blank"
                                    class="btn btn-primary btn-sm mr-1"><i class="fas fa-print mr-1"></i></a> --}}
                                <a href="{{ route('admin.riwayat', $row->id) }}" class="btn btn-info btn-sm"><i
