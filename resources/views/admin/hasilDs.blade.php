    ...
    <div class="container-fluid p-0 m-0 my-5">
        ...
        <div class="card kartu-custom mb-3">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($diagnosa->gejala_penyakit as $gejalaYangDipilih)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $gejalaYangDipilih->kode }}</td>
                                    <td>{{ $gejalaYangDipilih->nama }}</td>
                                </tr>
                                @php
                                    $i++;
                                @endphp
                ...
                <<div class="container-fluid">
                    <h6 class="text-custom">*) Penyebab Penyakit</h6>
                    <table class="table table-bordered custom-table" style="width: 100%">
                        <tbody>
                            <tr>
        ...
        <a href="{{ route('admin.riwayatds.daftar') }}" class="btn btn-custom"><i class="fa-solid fa-arrow-left me-1"></i> Kembali
            ke
            Halaman Diagnosa</a>
    </div>
