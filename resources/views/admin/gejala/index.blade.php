        ...
        <form action="{{ route('admin.gejala.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="nilai_densitas">Nilai Densitas</label>
                            <input type="decimal" class="form-control" name="nilai_densitas">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            $('.edit').click(function() {
                ...
                $.get(`{{ route('admin.gejala.json') }}?id=${id}`, function(res) {
                    ...
                    $('#edit-gejala input[name="nilai_densitas"]').val(res.nilai_densitas)
