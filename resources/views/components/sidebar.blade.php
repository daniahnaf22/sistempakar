<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <x-nav-link 
        text="Diagnosa DS" 
        icon="stethoscope" 
        url="{{ route('admin.diagnosaDs') }}"
        active="{{ request()->routeIs('admin.diagnosaDs') ? ' active' : '' }}"
    />
    @endcan --}}
    ...
    {{-- @can('riwayatDs-list')
    <x-nav-link 
        text="Riwayat Diagnosa DS" 
        icon="notes-medical" 
        url="{{ route('admin.riwayatds.daftar') }}"
        active="{{ request()->routeIs('admin.riwayatds.daftar') ? ' active' : '' }}"
    />
    @endcan --}}
    ...
    <x-nav-link 
        text="Basis Rules DS" 
        icon="briefcase-medical" 
        url="{{ route('admin.ruleDs') }}"
        active="{{ request()->routeIs('admin.ruleDs') ? ' active' : '' }}"
    />
    @endcan
